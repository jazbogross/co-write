...
CREATE OR REPLACE FUNCTION public.append_to_edited_by(script_id uuid, user_id uuid)
RETURNS jsonb
LANGUAGE plpgsql
AS $$
DECLARE
...
BEGIN
  ...
  SELECT edited_by INTO current_edited_by FROM scripts WHERE id = script_id;
